...
-- 预置活动类型数据
INSERT INTO activity_type (id, name, description, category_id, sort_order) VALUES
-- 服务类下的具体活动类型
(1, '学校文体比赛', '学校组织的文艺、体育类比赛活动', 1, 1),
(2, '志愿服务活动', '校内外志愿服务活动记录', 1, 2),
(3, '学生社团活动', '学生社团组织的各类活动', 1, 3),
-- 个人业务类下的具体活动类型
(4, '大学生创新创业训练计划', '大创项目申报与结题', 2, 4),
(5, '学科竞赛', '各类学科竞赛（数学建模、程序设计等）', 2, 5),
(6, '技能证书', '各类专业技能证书考取', 2, 6);
